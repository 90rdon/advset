...
public class CrmApi
{
    ...
    /// <param name="policyNumber"></param>
    public void CreateEmailActivity(Guid from, List<Guid> accountIds, List<String> sharepointDocuments, Guid regardingObjectId, String caseNumber, String policyNumber, String textNote)
    {
        ...
        {
            caseNumber = "Case Number: Not given.";
        }
        ...
        foreach (Guid accountId in accountIds)
        {
            ...
            NewEmail[EmailConstants.Subject] = caseNumber;
            NewEmail[EmailConstants.Description] = BuildMessageBody(accountId, sharepointDocuments, policyNumber, caseNumber, textNote);
            ...
            catch (FaultException<OrganizationServiceFault> CreateError)
            {
                ...
                CreateMessage.AppendFormat(CultureInfo.CurrentCulture, "An Error occurred attempting to create Email for Policy: {0} and Case: {1}. \r\n Details: {3}",
                                        policyNumber, caseNumber, CreateError.ToString());
                ...
                catch (FaultException<OrganizationServiceFault> SendError)
                {
                    ...
                    CreateMessage.AppendFormat(CultureInfo.CurrentCulture, "An Error occurred attempting to Send Email for Policy: {0} and Case: {1}. \r\n Details: {3}. "
                        + "The Email message was created but it has not been sent. Please reivew the Activities section of this record for further details.",
                                            policyNumber, caseNumber, SendError.ToString());
    ...
    private String BuildMessageBody(Guid accountId, List<String> sharePointLinks, String policyNumber, String caseNumber, String textNote)
    {
        ...
        {
            String[] MemberTokens = caseNumber.Split('-');
    ...
    public EntityCollection GetClientFromPolicyNumber(String policyNumber)
    {
        if (String.IsNullOrWhiteSpace(policyNumber))
        {
