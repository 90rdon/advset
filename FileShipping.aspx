            ...
            <div class="row col-md-8">
                ...
                <div class="tab-content">
                    <div id="InvestorDetails" class="tab-pane fade in active">
                        ...
                        <asp:GridView ID="GridViewInvestors" runat="server" CssClass="table table-striped" DataKeyNames="accountid" AutoGenerateColumns="False" OnRowCreated="GridViewInvestors_RowCreated">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                    ...
                    <div id="documents" class="tab-pane fade">
                         <asp:GridView ID="GridViewDocumentDetails" runat="server" AutoGenerateColumns="False" DataKeyNames="DocumentName" OnSelectedIndexChanged="GridViewDocumentDetails_SelectedIndexChanged" CssClass="table table-striped">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="SelectColumn" runat="server" Width="50px" />
