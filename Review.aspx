...
<body>
    <div class="container">
        ...
        <form id="form1" runat="server" class="form-signin" role="form">
            <div id="authentiction" class="row col-md-12">
                <asp:Panel ID="AuthenticationPanel" runat="server" CssClass="col-md-4">
                    ...
                    <div id="InfoMessage">
                        <small><asp:Label ID="lblInvalidAuthentication" runat="server" Visible="False" CssClass="text-warning"></asp:Label></small>
                        
                    </div>
                    <br />
                </asp:Panel>
            </div>
            <div id="configoptions" class="row">
                <asp:Panel ID="ConfigOptions" runat="server" CssClass="col-md-4">
                    <div class="form-group">
                        <label for="tbLookbackPeriod" class="control-label" style="padding:0px">Lookback Period:</label>
                    ...
                    <div class="form-group">
                        <label for="tbPageSize" class="control-label" style="padding:0px">Page Size:</label>
            ...
            <div id="Greeting" class="col-md-9 row">
